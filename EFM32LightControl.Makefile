...
PROJECTNAME = 
ARM_GCC_DIR_WIN = C:/SiliconLabs/SimplicityStudio/v5/developer/toolchains/gnu_arm/7.2_2017q4
ARM_GCC_DIR_OSX = 
ARM_GCC_DIR_LINUX = 
...
####################################################################
-include EFM32LightControl.project.mak
...
CXXSOURCES     = $(notdir $(CXX_SOURCE_FILES))
...
ASMOBJS_S   = $(addprefix $(OUTPUT_DIR)/,$(ASMSOURCES_S:.S=.o))
OBJS        += $(COBJS) $(CXXOBJS) $(ASMOBJS_s) $(ASMOBJS_S)
